<div id="<?php print $stats_id;?>" class="milestone-counter <?php print $class;?>"><div class="milestone-icon"><i class="<?php if ($icon != '') {print $icon;} ?>"></i></div><div class="stat-title"><span class="stat-count highlight"><?php print $number; ?></span><?php if($title!=''){ print ' '.$title;} ?></div><div class="milestone-details"><?php print $content; ?></div></div>
<script type="text/javascript">
jQuery(document).ready(function($){
	$('#<?php print $stats_id;?> .stat-count').each(function() {
		var start = <?php print $start_number;?>;
                var number = <?php print $number;?>;
