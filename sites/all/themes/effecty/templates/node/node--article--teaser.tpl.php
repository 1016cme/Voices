      ...
      <?php print render($title_suffix); ?>
          ...
          <div class="blog-image">
            ...
            <div class="blog-social">
              <div class="blog-comment inline-block"><i class="fa fa-comments-o mr3"></i>
                <span class="mr3"> <?php print $comment_count; ?></span> <?php print t('Replies')?></div>
              <div class="blog-flag inline-block"><?php print flag_create_link("flag_like", $node->nid);?></div>
            </div>
        ...
        <a href="<?php print $node_url;?>" title=""><?php print $title;?></a>
            ...
            <!-- end desc -->
              ...
              <a href="<?php print $node_url;?>" title="" class="bt4n bten-readmore">
                <div class="btn-read-more rm1"><?php print t('read more');?></div>
              </a>
              <div  class="btn-read-more rm2"><?php print t('read more');?></div>
            </div>
          </div>
        </div>
  </div>
