    ...
    <?php print render($title_prefix); ?>
      <?php print render($title_suffix); ?>
        ...
        <div class="testimonials-item text-center">
          ...
          <div class="testimonials-detail-wrapper pl80 pr80">
        ...
        <?php print $title;?>
              ...
              <div class="testimonials-meta">
                <div class="testimonials-position ">
                  <?php if(isset($content['field_testimonial_position'])) print render($content['field_testimonial_position']);?>
                </div>
              </div>
              <!-- end meta -->
              ...
              <div class="testimonials-social">
                <?php print render($content['field_testimonial_social']);?>
              </div>
            </div>
