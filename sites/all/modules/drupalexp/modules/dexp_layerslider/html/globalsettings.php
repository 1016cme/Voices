...
<fieldset class="form-wrapper">
  ...
  <div class="form-global-setting-item">
    <label>Loop Single Slide</label>
    <select name="loopsingle" class="form-select global-settings">
...
<fieldset class="form-wrapper">
  <legend><span class="fieldset-legend">Custom Font & CSS</span></legend>
  <div class="form-global-setting-item">
    <label>Google Fonts</label>
    <input name="google_fonts" class="form-text global-settings"/>
  </div>
  <div class="form-global-setting-item">
    <label>Custom CSS</label>
    <textarea name="custom_css" style="width:100%;height:300px;" class="form-textarea global-settings"></textarea>
  </div>
</fieldset>
